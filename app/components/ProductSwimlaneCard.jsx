...
export function ProductSwimlaneCard({
  product,
  label,
  className,
  loading,
  ...
  return (
    <div className="flex flex-col border-solid border-r border-gray-400 last:border-r-0 hb1--prod-bg">
      <Link
        onClick={onClick}
        to={`/products/${product.handle}`}
        prefetch="intent"
      >
        <div className={clsx('grid cust-cursor-2 relative', className)}>
